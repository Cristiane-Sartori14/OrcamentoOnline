...
window.addEventListener("load", () => {
  ...
  calcularTotal();
  inicializarCanvasAssinatura(); // Aqui você inicializa o canvas corretamente
});
...
const botao = document.querySelector("#gerarPdf");
if (!botao) {
  console.error("Botão #gerarPdf não encontrado!");
} else {
  console.log("Botão #gerarPdf conectado com sucesso.");
  botao.addEventListener("click", salvarOrcamento);
}
